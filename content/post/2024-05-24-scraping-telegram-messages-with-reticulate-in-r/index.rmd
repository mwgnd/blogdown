...
```{r, include=FALSE}
library(tidyverse)
py_list <- readRDS("~/Data/Sonstiges/compactmagazin.rds")
...
stm_model <- readRDS("~/Data/Sonstiges/stm_model.rds")
prep <- readRDS("~/Data/Sonstiges/prep.rds")
df <- readRDS("~/Data/Sonstiges/df.rds")
